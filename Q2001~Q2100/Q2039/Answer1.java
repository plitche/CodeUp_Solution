...
public class Answer1 {
	...
	public static void main(String[] args) throws IOException {
        ...
        for (int i=0; i<classCount; i++) {
        	sb.append(startHour).append(":").append(String.format("%02d",startMin)).append("-");
        	...
        	startHour+=plusHour;
        	sb.append(startHour).append(":").append(String.format("%02d",startMin)).append(" ").append(i+1).append("교시");
        	...
        	if (!isLunch) {
        		if (i+1==whenLunch || i+1==classCount) {
            		...
            		sb.append(startHour).append(":").append(String.format("%02d",startMin)).append(" ").append("점심시간").append("\n");
